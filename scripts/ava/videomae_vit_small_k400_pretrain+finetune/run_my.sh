...
OUTPUT_DIR='/storage/wangxinxing/code/VideoMAE-Action-Detection/runs/ava_videomae_vit_small_k400_pretrain+finetune'
...
OMP_NUM_THREADS=1 python3 -m torch.distributed.launch --nproc_per_node=4 --master_port 12320 --nnodes=1 \
